...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsControlJustPressed(21, 303) then
            ...
            local notowned = 0
            if #cars == 0 then
                notify:DoHudText('error', 'No vehicles to close nearby.')
            else
                for j=1, #cars, 1 do
                    ...
                    ESX.TriggerServerCallback('carlock:isVehicleOwner', function(owner)
                        if owner and not hasAlreadyLocked then
                            ...
                            if lock == 1 or lock == 0 then
                                ...
                                notify:DoHudText('success', 'You have closed your Vehicle.')
                            ...
                            elseif lock == 2 then
                                ...
                                notify:DoHudText('success','You have opened your Vehicle.')
                                if not IsPedInAnyVehicle(PlayerPedId(), true) then
                                    TaskPlayAnim(PlayerPedId(), dict, "fob_click_fp", 8.0, 8.0, -1, 48, 1, false, false, false)
                                end
                                SetVehicleLights(carstrie[i], 2)
