...
function closeUI(){
    ...
    xhr.open("POST", `https://${GetParentResourceName()}/close`, true);                                                                                                                                                                                                                                                                                                                                      
    xhr.send(JSON.stringify({}));
}
function easyTimeChange(values, savesettings){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", `https://${GetParentResourceName()}/change`, true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-time").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", `https://${GetParentResourceName()}/instanttime`, true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-weather").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", `https://${GetParentResourceName()}/instantweather`, true);                                                                                                                                                                                                                                                                                                                                      
